...
$options_saved = isset($_GET['options_saved']); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
...
<div class="wrap">
    ...
    <form method="post" action="<?php echo esc_url(remove_Query_Arg('options_saved')) ?>">
