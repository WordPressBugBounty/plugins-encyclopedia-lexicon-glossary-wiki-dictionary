...
abstract class I18n
{
    ...
    public static function translate(string $text, string $context = ''): string
    {
        if (apply_filters('encyclopedia_translate', true, $text, $context)) {
            ...
            if (empty($context))
                return translate($text, static::textdomain); // phpcs:ignore WordPress.WP.I18n.LowLevelTranslationFunction, WordPress.WP.I18n.NonSingularStringLiteralText, WordPress.WP.I18n.NonSingularStringLiteralDomain
            else
                return translate_With_GetText_Context($text, $context, static::textdomain);  // phpcs:ignore WordPress.WP.I18n.LowLevelTranslationFunction, WordPress.WP.I18n.NonSingularStringLiteralText, WordPress.WP.I18n.NonSingularStringLiteralDomain, WordPress.WP.I18n.NonSingularStringLiteralContext
        } else {
            return $text;
        }
    }
